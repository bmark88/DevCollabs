...
VALUES
  (1, 1, 'Checkout this out!', 'https://744025.smushcdn.com/1245953/wp-content/uploads/2019/07/is-coding-hard-to-learn.jpg?lossy=1&strip=1&webp=1', NOW()::TIMESTAMP);
...
VALUES
  (1, 2, 'Does anyone know how to to use websockets?', NOW()::TIMESTAMP);
